export default function SchemaMarkup() {
  const schema = {
    ...
    downloadUrl: "https://habitforge.fr/download",
    softwareVersion: "1.0.0",
    fileSize: "25MB",
    screenshot: [
      "https://habitforge.fr/home_screen.png",
      "https://habitforge.fr/habits_screen.png",
      "https://habitforge.fr/settings_screen.png",
    ],
    featureList: [
