...
export const ENCOURAGING_MESSAGES: Record<
  "achievement" | "setback" | "daily" | "milestone",
  EncouragingMessage[]
> = {
  daily: [
  ...
  setback: [
    {
      message:
        "Don't worry, a small setback is just a setup for a major comeback.",
    },
  ...
  milestone: [
    {
      message:
        "Congratulations on reaching a {streak}-day milestone! You are unstoppable.",
    },
    {
      message:
        "You've hit a major milestone of {streak} days! Celebrate your progress.",
    },
  ],
};
